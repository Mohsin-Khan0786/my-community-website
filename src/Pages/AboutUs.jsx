  ...
  return (
    <div className="max-w-full mx-auto px-4 py-12 overflow-hidden">
      <section className="w-full flex items-end justify-between mb-12 p-5">
        <h1 className="sm:text-[4vw] text-3xl font-bold uppercase text-white mb-4">
          WHO WE ARE
        </h1>
      ...
      <section className="flex flex-col gap-5 sm:flex-row justify-between capitalize items-center mb-12 p-8">
        <h2 className="sm:text-5xl text-5xl mb-6 font-bold text-white">
        ...
        <div className="members flex flex-col w-full p-5">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <h1 className="sm:text-3xl text-2xl capitalize text-start">
                {member.name}
              </h1>
              <img
      ...
      <section className="text-end mr-5 mt-12 flex flex-col gap-5">
        <h2 className="text-3xl font-bold text-white">Established in</h2>
        <h3 className="text-5xl font-bold text-white">2023</h3>
