...
const genAI = new GoogleGenerativeAI("AIzaSyAT7hnoYdaktoQ5CwmBpbLVX0vliRwWL8c"); /* 👈 API Key here 👈*/
...
const Chatbot = () => {
  ...
  return (
    <section className="h-[78vh] mx-auto w-[90%] flex flex-col justify-between my-6">
      {/* Messages Container */}
      <div id="overflow" className="flex-grow p-4 overflow-y-scroll space-y-4">
